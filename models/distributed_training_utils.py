...
def add_sign(target, source1):
    for name in target:
        target[name].data = torch.sign(source1[name].data.clone())
...
class Client(DistributedTrainingDevice):
    ...
    def __init__(self, model, args, trn_x, trn_y, dataset_name, id_num=0):
        ...
        self.m = {name: torch.zeros(value.shape).to(self.args.device) for name, value in self.W.items() }
        self.U = {name: torch.zeros(value.shape).to(self.args.device) for name, value in self.W.items() }
    ...
    def train_cnn(self, server, iter):
        ...
        if self.args.method == 'fedavg' or self.args.method == 'fedadam' or self.args.method == 'fedyogi' or self.args.method == 'fedadagrad' or self.args.method == 'fedavgm' or self.args.method == 'fedavg_gnag' or self.args.method == 'fed_nesterov' or self.args.method == 'mime' or self.args.method == 'scaffold' or self.args.method == 'fedsmu':
        ...
        for iter in range(self.args.local_ep):
            ...
            for i in range(self.local_epoch):
                ...
                if self.args.method == 'fedavg' or self.args.method == 'fedadam' or self.args.method == 'fedyogi' or self.args.method == 'fedadagrad' or self.args.method == 'fedavgm' or self.args.method == 'fedavg_gnag' or self.args.method == 'fed_localnesterov' or self.args.method =='fed_localnesterov_nocom' or self.args.method == 'fed_localmome' or self.args.method == 'fedsmu':
                    loss = loss_f_i
                ...
                elif self.args.method == 'fedavg' or self.args.method == 'fedadam' or self.args.method == 'fedyogi' or self.args.method == 'fedadagrad' or self.args.method == 'fedavgm' or self.args.method == 'fedavg_gnag' or self.args.method == 'fedprox' or self.args.method == 'fed_nesterov' or self.args.method == 'fed_nesterov' or self.args.method == 'scaffold' or self.args.method == 'feddyn' or self.args.method == 'mime' or self.args.method == 'fedsmu':
                    optimizer.step()
...
class Server(DistributedTrainingDevice):
    ...
    def computer_weight_update_down_dw(self, clients, iter):
        ...
        if  self.args.method == 'fedsmu':
            average(target=self.dW, sources=[client.U for client in clients])
            add_mome2(target=self.W, source1=self.W, source2=self.dW, beta_1=1-self.args.globallr1*self.args.globallr2, beta_2=self.args.globallr1)
        elif self.args.method == 'fedavgm':
