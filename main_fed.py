...
if __name__ == '__main__':
    ...
    for iter in range(args.epochs):
        ...
        logger.info('Epoch:[{}]\tgloballr1 =\t{:.5f}\tloss=\t{:.5f}\tloss2=\t{:.5f}\t acc_train=\t{:.5f}\tacc_test=\t{:.5f}'.
                    format(iter, args.globallr1, loss_train1, loss_test1, results_train, results_test))

        args.globallr1 = args.globallr1 * (args.lr_decay)
