...
For example, for 100 clients and 10% participation rate, on the CIFAR-10 / CIFAR-100 / Shakespreare dataset with Dirichlet (0.25) split, we test the accuracy of . Notice that we put the dataset in the 'Folder'.
